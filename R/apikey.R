#' Set an open api key
#'
#' Set an open api key to use v-world.
#'
#' @description
...
#'
#' VWORLD_API_KEY="YOUR API KEY" \cr
#'
#'
...
set_api_key <- function(api_key) {
  Sys.setenv(VWORLD_API_KEY = api_key)
}

get_api_key <- function() {
  api_key <- Sys.getenv("VWORLD_API_KEY")
  if (api_key == "") {
    stop("Please code `usethis::edit_r_environ()` and provide your VWORLD_API_KEY='your-api-key' to .Renviron",
      call. = FALSE
    )
  }
  return(api_key)
